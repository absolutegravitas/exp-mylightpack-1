...
export default function HeroSection() {
  ...
  return (
    <>
      ...
      <main>
        <div aria-hidden className="absolute inset-0 isolate z-2 hidden opacity-50 contain-strict lg:block">
          ...
          <div className="relative mx-auto max-w-5xl px-6 py-28 lg:py-24">
            <div className="relative z-10 mx-auto max-w-2xl text-center">
              ...
              <p className="mx-auto my-8 max-w-2xl text-xl">
                Officiis laudantium excepturi ducimus rerum dignissimos, and tempora nam vitae, excepturi ducimus iste
                provident dolores.
              </p>
            ...
            <div className="-mr-16 pl-16 perspective-distant lg:-mr-56 lg:pl-56">
              <div className="[transform:rotateX(20deg);]">
                <div className="relative skew-x-[.36rad] lg:h-176">
                  ...
                  />
                  <div aria-hidden className="from-background absolute inset-0 z-11 bg-gradient-to-l" />
                  <div
                    aria-hidden
