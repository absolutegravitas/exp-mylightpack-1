...
const FaceRating_Basic = ({ className, iconSize = 24, onChange, value }: FaceRatingBasicProps) => {
  ...
  return <div className={cn("flex items-center gap-x-0.5", className)}>{icons}</div>
}
