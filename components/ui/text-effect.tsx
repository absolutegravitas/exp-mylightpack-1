...
const hasTransition = (variant: Variant): variant is TargetAndTransition => {
  return typeof variant === "object" && variant !== null && "transition" in variant && variant.transition !== undefined
}
...
const createVariantsWithTransition = (
  ...
  return {
    ...
    visible: {
      ...
      transition: {
        ...(baseVariants.visible && hasTransition(baseVariants.visible) ? baseVariants.visible.transition : {}),
        ...mainTransition,
      },
    },
    exit: {
