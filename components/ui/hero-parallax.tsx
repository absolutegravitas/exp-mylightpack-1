...
export const Header = () => {
  const words = ["gram", "ounce", "kilo", "pound", "litre", "gallon", "millilitre", "cup", "teaspoon"]

  return (
    <div className="relative top-0 left-0 mx-auto w-full max-w-7xl px-4 py-20 md:py-40">
      <div className="flex items-center justify-center px-4 py-2"></div>
      <div className="mx-auto text-4xl font-normal text-neutral-600 dark:text-neutral-400">
        ...
        <br />
        {`When every`}
        <FlipWords words={words} /> {`counts.`}
      </div>
      <h1 className="text-2xl font-bold md:text-7xl dark:text-white">myLightPack</h1>
