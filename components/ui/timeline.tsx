...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div className="w-full bg-white py-16 font-sans md:px-10 dark:bg-neutral-950" ref={containerRef}>
      <h2 className="mb-4 max-w-4xl text-lg text-black md:text-4xl dark:text-white">Changelog from my journey</h2>
      <p className="text-gray-600">Stay up-to-date with the latest changes and improvements to MyLightpack.</p>
